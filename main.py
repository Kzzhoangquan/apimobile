...
from models import Option, Question, Quiz, QuizResult, User, Course, Lesson
...
@app.post("/courses/{courseId}/enrollments")
def enroll_in_course(courseId: int, request_body: dict, db: Session = Depends(get_db)):
...
def get_scores(
    ...
    # Implementation for scores would go here
